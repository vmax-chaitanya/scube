                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="mb-3 row">
                      <label
                        ...
                        class="col-sm-2 col-form-label text-end">Large</label>
                      <div class="col-sm-10">
                        <input
                    ...
                    <div class="mb-3 row">
                      <label
                        ...
                        class="col-sm-2 col-form-label text-end">Small</label>
                      <div class="col-sm-10">
                        <input
                  ...
                  <div class="col-lg-6">
                    <div class="mb-3 row">
                      <label
                        ...
                        class="col-sm-2 col-form-label text-end">Search</label>
                      <div class="col-sm-10">
                        <input
                          class="form-control"
                          type="search"
                    ...
                    <div class="mb-3 row">
                      <label
                        ...
                        class="col-sm-2 col-form-label text-end">URL</label>
                      <div class="col-sm-10">
                        <input
                          class="form-control"
                          type="url"
                    ...
                    <div class="mb-3 row">
                      <label
                        ...
                        class="col-sm-2 col-form-label text-end">Date</label>
                      <div class="col-sm-10">
                        <input
                          class="form-control"
                          type="date"
                    ...
                    <div class="mb-3 row">
                      <label
                        ...
                        class="col-sm-2 col-form-label text-end">Month</label>
                      <div class="col-sm-10">
                        <input
                          class="form-control"
                          type="month"
                    ...
                    <div class="mb-3 row">
                      <label
                        ...
                        class="col-sm-2 col-form-label text-end">Week</label>
                      <div class="col-sm-10">
                        <input
                          class="form-control"
                          type="week"
                    ...
                    <div class="mb-3 row">
                      <label
                        ...
                        class="col-sm-2 col-form-label text-end">Time</label>
                      <div class="col-sm-10">
                        <input
                          class="form-control"
                          type="time"
              ...
              <div class="card-body pt-0">
                <form>
                  ...
                  <div class="">
                    <label
                      class="form-label"
                      for="exampleFormControlTextarea1">Example textarea</label>
                    <textarea
                      class="form-control"
                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="form-check form-switch">
                      ...
                      <label
                        class="form-check-label"
                        for="flexSwitchCheckDefault">Default switch</label>
                    </div>
                    ...
                    <div class="form-check form-switch">
                      ...
                      <label
                        class="form-check-label"
                        for="flexSwitchCheckDisabled">Disabled switch
                      </label>
                    </div>
                  </div>
                  <!--end col-->
                  <div class="col-lg-4">
                    <div class="form-check form-switch form-switch-secondary">
                      ...
                      <label
                        class="form-check-label"
                        for="customSwitchSecondary">Secondary</label>
                    </div>
                    ...
                    <div class="form-check form-switch form-switch-success">
                      ...
                      <label
                        class="form-check-label"
                        for="customSwitchSuccess">Success</label>
                    </div>
                    ...
                    <div class="form-check form-switch form-switch-warning">
                      ...
                      <label
                        class="form-check-label"
                        for="customSwitchWarning">Warning</label>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      ...
                      <label
                        ...
                        for="btn-check-outlined">Single toggle</label><br />
                    </div>
                  </div>
                  <!--end row-->
                </form>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      ...
                      <label
                        ...
                        for="success-outlined">Checked success radio</label>
            ...
            <div class="card">
              ...
              <div class="card-body pt-0">
                ...
                <div class="input-group mb-3">
                  ...
                  <span class="input-group-text" id="basic-addon2">@SCUBE.com</span>
                </div>

                <label for="basic-url" class="form-label">Your vanity URL</label>
                <div class="input-group mb-3">
                  <span class="input-group-text" id="basic-addon3">https://SCUBE.com</span>
                  <input
                    type="text"
                    class="form-control"
                    id="basic-url"
