              ...
              <div class="card">
                ...
                <div class="card-body pt-0">
                  <form>
                    ...
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect2"
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="form-check form-switch form-switch-info">
                        <input
                          ...
                          checked
                        />
                        <label class="form-check-label" for="customSwitchInfo"
                          >Info</label
                        >
                      </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                      <div class="form-check form-switch form-switch-danger">
                        <input
                          ...
                          checked
                        />
                        <label class="form-check-label" for="customSwitchDanger"
                          >Danger</label
                        >
                      </div>
                      ...
                      <div class="form-check form-switch form-switch-dark">
                        <input
                          ...
                          checked
                        />
                        <label class="form-check-label" for="customSwitchDark"
                          >Dark</label
                        >
                      </div>
                      ...
                      <div class="form-check form-switch form-switch-purple">
                        <input
                          ...
                          checked
                        />
                        <label class="form-check-label" for="customSwitchPurple"
                          >Purple</label
                        >
                      </div>
                      ...
                      <div class="form-check form-switch form-switch-pink">
                        <input
                          ...
                          checked
                        />
                        <label class="form-check-label" for="customSwitchPink"
                          >Pink</label
                        >
                      </div>
                    </div>
